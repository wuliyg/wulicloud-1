package com.wulis.provider.config;//package com.wulis.provider.config;
...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .authorizeRequests().antMatchers("/member/login", "/actuator/**", "/swagger-ui.html", "/swagger-resources/**", "/v2/api-docs").permitAll()
